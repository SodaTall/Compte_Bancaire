...
<body>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" action="account_management.php">
                                ...
                                <select name="type" class="form-select" onchange="toggleRecipientField(this)">
                                    <option value="depot">Dépôt</option>
                                    <option value="retrait">Retrait</option>
                                    <option value="virement">Virement</option>
                                </select>
                                <input type="number" name="amount" class="form-control" placeholder="Montant" required>
                                <input type="text" name="recipient_account_number" class="form-control" placeholder="Numéro de Compte Bénéficiaire (pour virement)" style="display:none;">
    ...
    <script>
        function toggleRecipientField(selectElement) {
            var recipientField = selectElement.parentNode.querySelector('input[name="recipient_account_number"]');
            if (selectElement.value === 'virement') {
